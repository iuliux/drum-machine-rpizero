...
class OLEDHandler:
    ...
    def __init__(self, sequencer):
        ...
        # Create metronome icon (34x34px) - draw it programmatically
        self.metronome_icon = Image.new('1', (34, 34), 0)
        draw = ImageDraw.Draw(self.metronome_icon)
        
        # Draw metronome triangle shape
        # Outer triangle (slanted metronome body)
        triangle_points = [(17, 2), (5, 30), (29, 30)]
        draw.polygon(triangle_points, outline=1, fill=0)
        
        # Inner triangle to create hollow effect
        inner_triangle = [(17, 6), (9, 28), (25, 28)]
        draw.polygon(inner_triangle, outline=0, fill=0)
        
        # Draw the base (wide rectangle at bottom)
        draw.rectangle([(2, 30), (32, 32)], outline=1, fill=1)
        
        # Draw the pendulum arm (angled line)
        draw.line([(17, 8), (22, 20)], fill=1, width=2)
